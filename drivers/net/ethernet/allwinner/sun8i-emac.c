...
/* TODO check for a min value. customizable value ? if not jumbo less value ?*/
...
static void sun8i_emac_ethtool_strings(struct net_device *dev, u32 stringset, u8 *buffer)
{
	switch (stringset) {
		case ETH_SS_STATS:
